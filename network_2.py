...
class NetworkPacket:
    ...
    def __init__(self, src, dst, data_S, priority=0):
        self.src = src
        self.dst = dst
        self.data_S = data_S
        # TODO: add priority to the packet class PART3
...
class Host:
    ...
    # @param priority: packet priority
    def udt_send(self, src, dst, data_S, priority=0):


        pkt = NetworkPacket(src, dst, data_S)
